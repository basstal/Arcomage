...
partial class Connection
{
    ...
    public void DrawConnectionGUI(Vector3 lineFrom, Vector3 lineTo)
    {
        ...
        var mlt = 0f;
        if (Preferences.connectionStyle == Preferences.ConnectionStyle.Curved) { mlt = 0.8f; }
        if (Preferences.connectionStyle == Preferences.ConnectionStyle.Stepped) { mlt = 1f; }
    ...
    void DrawConnection(Vector3 lineFrom, Vector3 lineTo)
    {
        ...
        if (Preferences.connectionStyle == Preferences.ConnectionStyle.Curved)
        {
        ...
        else if (Preferences.connectionStyle == Preferences.ConnectionStyle.Stepped)
        {
    ...
    {
        if (RectTools.GetBoundRect(lineFrom, lineTo).Contains(targetPosition))
        {
    ...
    public void ShowConnectionInspectorGUI()
    {
        ...
        UndoTools.CheckUndo(graph, "Connection Inspector");
