    ...
    public class FCodeWindow : EditorWindow, IHasCustomMenu
    {
        ...
        void DrawLogicSelection(Rect rect)
        {
            ...
            GUI.BeginGroup(rect);
            {
                ...
                m_scrollView1 = GUILayout.BeginScrollView(m_scrollView1);
                {
        ...
        void DrawLogicContent(Rect rect)
        {
            GUILayout.BeginHorizontal();
            {
                ...
                m_scrollView2 = GUILayout.BeginScrollView(m_scrollView2, GUILayout.Width(position.width * 2 / 3));
                {
                ...
                GUILayout.BeginVertical();
                m_scrollView3 = GUILayout.BeginScrollView(m_scrollView3, GUILayout.Width(position.width / 3));
                {
        ...
        private void OnGUI()
        {
            ...
            showLogic = GUILayout.Toggle(showLogic, showLabel, EditorStyles.toolbarButton);
            GUILayout.EndHorizontal();
