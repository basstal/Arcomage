...
partial class EditorTools
{
    ...
    public static GenericMenu GetTypeSelectionMenu(int type, Action<Type> callback, GenericMenu menu = null, string subCategory = null)
    {
        if (menu == null)
        {
            menu = new GenericMenu();
        ...
        var scriptInfos = GetScriptInfosOfType(type);
