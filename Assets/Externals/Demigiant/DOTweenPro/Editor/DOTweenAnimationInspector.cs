...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<TweenAnimationType, Type[]> _AnimationTypeToComponent = new Dictionary<TweenAnimationType, Type[]>() {
            { TweenAnimationType.Move, new[] {
            ...
            { TweenAnimationType.LocalMove, new[] { typeof(Transform) } },
            { TweenAnimationType.LocalRotate, new[] { typeof(Transform) } },
            { TweenAnimationType.Scale, new[] { typeof(Transform) } },
            { TweenAnimationType.Color, new[] {
                typeof(Light),
...
#if true // UI_MARKER
            { TweenAnimationType.Text, new[] { typeof(Text) } },
#endif
            { TweenAnimationType.PunchPosition, new[] {
#if true // UI_MARKER
                typeof(RectTransform),
#endif
                typeof(Transform)
            }},
            { TweenAnimationType.PunchRotation, new[] { typeof(Transform) } },
            { TweenAnimationType.PunchScale, new[] { typeof(Transform) } },
            { TweenAnimationType.ShakePosition, new[] {
#if true // UI_MARKER
                typeof(RectTransform),
#endif
                typeof(Transform)
            }},
            { TweenAnimationType.ShakeRotation, new[] { typeof(Transform) } },
            { TweenAnimationType.ShakeScale, new[] { typeof(Transform) } },
            { TweenAnimationType.CameraAspect, new[] { typeof(Camera) } },
            { TweenAnimationType.CameraBackgroundColor, new[] { typeof(Camera) } },
            { TweenAnimationType.CameraFieldOfView, new[] { typeof(Camera) } },
            { TweenAnimationType.CameraOrthoSize, new[] { typeof(Camera) } },
            { TweenAnimationType.CameraPixelRect, new[] { typeof(Camera) } },
            { TweenAnimationType.CameraRect, new[] { typeof(Camera) } },
#if true // UI_MARKER
            { TweenAnimationType.UIWidthHeight, new[] { typeof(RectTransform) } },
            { TweenAnimationType.UIAnchoredPosition, new[] { typeof(RectTransform) } },
            { TweenAnimationType.UIAnchoredPositionX, new[] { typeof(RectTransform) } },
            { TweenAnimationType.UIAnchoredPositionY, new[] { typeof(RectTransform) } },
#endif
        };

#if false // TK2D_MARKER
        static readonly Dictionary<TweenAnimationType, Type[]> _Tk2dAnimationTypeToComponent = new Dictionary<TweenAnimationType, Type[]>() {
            { TweenAnimationType.Scale, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { TweenAnimationType.Color, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { TweenAnimationType.Fade, new[] { typeof(tk2dBaseSprite), typeof(tk2dTextMesh) } },
            { TweenAnimationType.Text, new[] { typeof(tk2dTextMesh) } }
        };
#endif
#if true // TEXTMESHPRO_MARKER
        static readonly Dictionary<TweenAnimationType, Type[]> _TMPAnimationTypeToComponent = new Dictionary<TweenAnimationType, Type[]>() {
            { TweenAnimationType.Color, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { TweenAnimationType.Fade, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } },
            { TweenAnimationType.Text, new[] { typeof(TextMeshPro), typeof(TextMeshProUGUI) } }
        };
#endif
...
#endif
#if true // UI_MARKER
            "UI/WidthHeight", "UI/AnchoredPosition", "UI/AnchoredPositionX", "UI/AnchoredPositionY",
#endif
...
//            _src.isValid = Validate(); // Moved down
            ...
            if (targetGO == null) {
                ...
                GUILayout.BeginHorizontal();
                TweenAnimationType prevAnimType = _src.animationType;
//                _src.animationType = (TweenAnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
                GUI.enabled = GUI.enabled && _src.isActive;
                _src.animationType = AnimationToTweenAnimationType(_AnimationType[EditorGUILayout.Popup(TweenAnimationTypeToPopupId(_src.animationType), _AnimationType)]);
                ...
                if (prevAnimType != _src.animationType) {
                    ...
                    case TweenAnimationType.Scale:
                        ...
                        _src.optionalBool0 = _src.animationType == TweenAnimationType.Scale;
                        break;
                    case TweenAnimationType.UIWidthHeight:
                        _src.endValueV3 = Vector3.zero;
                        _src.endValueFloat = 0;
                        _src.optionalBool0 = _src.animationType == TweenAnimationType.UIWidthHeight;
                        break;
                    ...
                    case TweenAnimationType.PunchScale:
                        _src.endValueV3 = _src.animationType == TweenAnimationType.PunchRotation ? new Vector3(0, 180, 0) : Vector3.one;
                    ...
                    case TweenAnimationType.ShakeScale:
                        _src.endValueV3 = _src.animationType == TweenAnimationType.ShakeRotation ? new Vector3(90, 90, 90) : Vector3.one;
                        _src.optionalInt0 = 10;
                ...
                if (_src.animationType == TweenAnimationType.None) {
                    _src.isValid = false;
...
#if true // UI_MARKER
                    if (_src.animationType == TweenAnimationType.Fade && targetGO.GetComponent<CanvasGroup>() != null && targetGO.GetComponent<Image>() != null) {
                ...
                case TweenAnimationType.Move:
                case TweenAnimationType.LocalMove:
                    GUIEndValueV3(targetGO, _src.animationType == TweenAnimationType.Move);
                ...
                case TweenAnimationType.PunchScale:
                    ...
                    if (_src.animationType == TweenAnimationType.PunchPosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case TweenAnimationType.ShakePosition:
                case TweenAnimationType.ShakeRotation:
                case TweenAnimationType.ShakeScale:
                    ...
                    if (_src.animationType == TweenAnimationType.ShakePosition) _src.optionalBool0 = EditorGUILayout.Toggle("    Snapping", _src.optionalBool0);
                    break;
                case TweenAnimationType.CameraAspect:
                case TweenAnimationType.CameraFieldOfView:
                case TweenAnimationType.CameraOrthoSize:
        ...
        {
            if (_src.animationType == TweenAnimationType.None) return false;
        ...
        TweenAnimationType AnimationToTweenAnimationType(string animation)
        {
            if (_datString == null) _datString = Enum.GetNames(typeof(TweenAnimationType));
            animation = animation.Replace("/", "");
            return (TweenAnimationType)(Array.IndexOf(_datString, animation));
        }
        int TweenAnimationTypeToPopupId(TweenAnimationType animation)
        {
        ...
        void GUIEndValueFloat()
        {
            ...
            GUIToggleCurrent();
            if (!_src.fromCurrent)
                _src.fromValueFloat = EditorGUILayout.FloatField("From", _src.fromValueFloat);
        }
        ...
        void GUIEndValueColor()
        {
            ...
            GUIToggleCurrent();
            if (!_src.fromCurrent)
                _src.fromValueColor = EditorGUILayout.ColorField("From", _src.fromValueColor);
        }
        ...
        void GUIEndValueV3(GameObject targetGO, bool optionalTransform = false)
        {
            ...
            if (!_src.fromCurrent)
            {
                if (_src.useTargetAsV3)
                {
                    _src.fromValueTransform = EditorGUILayout.ObjectField("From", _src.fromValueTransform, typeof(Transform), true) as Transform;
                } 
                else 
                {
                    _src.fromValueV3 = EditorGUILayout.Vector3Field("From", _src.fromValueV3);
                }
            }
#if true // UI_MARKER
        ...
        void GUIEndValueV2()
        {
            ...
            GUIToggleCurrent();
            if (!_src.fromCurrent)
                _src.fromValueV2 = EditorGUILayout.Vector2Field("From", _src.fromValueV2);
        }
        ...
        void GUIEndValueRect()
        {
            ...
            GUIToggleCurrent();
            if (!_src.fromCurrent)
                _src.fromValueRect = EditorGUILayout.RectField("From", _src.fromValueRect);
        }

        void GUIToggleCurrent()
        {
            _src.fromCurrent = _src.isFrom || EditorGUILayout.Toggle( "From Current", _src.fromCurrent);
        }
