...
//     {
//         return m_localeMap.ContainsKey(Misc.CalculateHash(key));
//     }
//     private string GetString(string key)
//     {
//         if (!m_localeMap.TryGetValue(Misc.CalculateHash(key), out var result))
//         {
//             Log.LogWarning("Localization", $"Missing localization: {key}");
//             return key;
//         }
//         return result;
//     }
