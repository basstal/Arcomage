...
// {
//     public static IList<string> LuaAssetCandidates;
//
//     private Rect rect;
...
//             var sp = serializedObject.FindProperty("script");
//             GUI.enabled = false;
...
//                 () => Addressables.LoadResourceLocationsAsync(LuaManager.luaScriptsLabel),
//                 (path) =>
//                 {
//                     sp.stringValue = path;
