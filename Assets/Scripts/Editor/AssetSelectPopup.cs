...
public class AssetSelectTreeView : TreeView
{
    ...
    private Func<IEnumerable<string>> GetAssetCandidates;

    public AssetSelectTreeView(TreeViewState state, Func<IEnumerable<string>> _GetAssetCandidates, Action<string> _OnAssetSelected)
        : base(state)
    {
...
public class AssetSelectPopup : PopupWindowContent
{
    ...
    public static void Open(Rect rect, Func<IEnumerable<string>> GetAssetCandidates, Action<string> OnSelect)
    {
