...
namespace Arcomage.GameScripts.Utils
{
    public static class Misc
    {
        ...
        public static void BindButtonEvent(this Button target, UnityAction callback)
        {
            if (target != null)
            {
                SetEventHandler(target.onClick, callback);
                target.gameObject.SetGraphicRaycastTarget(true);
            }
        }
