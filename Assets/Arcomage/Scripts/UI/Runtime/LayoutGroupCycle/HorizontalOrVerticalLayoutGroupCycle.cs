...
namespace NOAH.UI
{
    ...
    public abstract class HorizontalOrVerticalLayoutGroupCycle : HorizontalOrVerticalLayoutGroup, ILayoutGroupCycle
    {
        ...
        protected override void Awake()
        {
            ...
            {
                // LogTool.LogError("Layout", "HorizontalOrVerticalLayoutGroupCycle should be used with ScrollRect.");
            }
        ...
        void LateUpdate()
        {
            ...
            if (m_PendingPopulateList.Count > 0)
            {
                m_PendingPopulateList.ForEach(go =>
                {
                    ...
                    // LogTool.LogInfo("Layout", $"HorizontalOrVerticlLayoutGroupCycle.PopulateChild({index})");
                });
