...
namespace Arcomage.GameScripts.Utils
{
    ...
    {
        public static ShellResult Shell(string executable, object[] args, string workingDir = null,
            bool waitForExit = true, Dictionary<string, string> envrionments = null)
        {
            try
            {
        ...
        public static ShellResult ShellWithError(string cmd, object[] args, string workingDir = null,
            bool waitForExit = true, Dictionary<string, string> envrionments = null)
        {
