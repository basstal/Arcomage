    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<DOTweenAnimation.AnimationType, Type[]> _AnimationTypeToComponent =
            new Dictionary<DOTweenAnimation.AnimationType, Type[]>()
            {
                ...
                { DOTweenAnimation.AnimationType.UIAnchoredPosition, new[] { typeof(RectTransform) } },
                { DOTweenAnimation.AnimationType.UIAnchoredPositionX, new[] { typeof(RectTransform) } },
                { DOTweenAnimation.AnimationType.UIAnchoredPositionY, new[] { typeof(RectTransform) } },
#endif
            };
 ...
 new Dictionary<DOTweenAnimation.AnimationType, Type[]>() {
...
#if UNITY_MODULES_UGUI // UI_MARKER
            "UIWidthHeight",
            "UIAnchoredPosition", "UIAnchoredPositionX", "UIAnchoredPositionY",
#endif
        ...
        private DOTweenSettings _settings
        {
            get
            {
                if (m_settings == null)
                {
                    // ** 这个操作等同于打开了 DOTween Utility Panel
                    m_settings = DOTweenUtilityWindow.ConnectToSource(null, true, true);
                }
...
//                _src.animationType = (DOTweenAnimation.AnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
                ...
                if (prevAnimType != _src.animationType)
                {
                    ...
                    switch (_src.animationType)
                    {
                        ...
                        case DOTweenAnimation.AnimationType.UIWidthHeight:
                            ...
                            break;
                        case DOTweenAnimation.AnimationType.UIAnchoredPositionX:
                        case DOTweenAnimation.AnimationType.UIAnchoredPositionY:
                            GUIEndValueFloat();
                            break;
                        case DOTweenAnimation.AnimationType.UIAnchoredPosition:
                            GUIEndValueV2();
                            break;
        ...
        {
            int index = Array.IndexOf(_animationTypeNoSlashes, animation.ToString());
